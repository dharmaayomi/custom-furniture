...
export const NavBody = ({ children, className, visible }: NavBodyProps) => {
  return (
    <motion.div
      ...
      className={cn(
        "relative z-60 container mx-auto hidden w-full flex-row items-center justify-between self-start rounded-full bg-transparent px-4 py-2 lg:flex dark:bg-transparent",
...
export const MobileNav = ({ children, className, visible }: MobileNavProps) => {
  return (
    <motion.div
      ...
      className={cn(
        "justify-betweenbg-transparent relative z-50 mx-auto flex w-full max-w-[calc(100vw-2rem)] flex-col items-center px-0 py-2 lg:hidden",
        visible && "bg-white/80 dark:bg-neutral-950/80",
        className,
      )}
    >
...
export const NavbarLogo = () => {
  ...
  return (
    ...
    >
      <Image src={logoSrc} alt="Logo" width={180} height={50} priority />
    </Link>
  );
};
...
export const NavbarThemeToggle = () => {
  ...
  return (
    <button
      ...
      title="Toggle theme"
      className="inline-flex h-9 w-9 items-center justify-center rounded-md text-black transition hover:bg-black/5 dark:text-white dark:hover:bg-white/10"
    >
      {mounted && theme === "dark" ? (
...
export const NavbarButton = ({
  ...
  const variantStyles = {
    primary:
      "bg-primary text-primary-foreground shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset] hover:bg-primary/90",
    secondary: "bg-transparent text-black shadow-none dark:text-white",
