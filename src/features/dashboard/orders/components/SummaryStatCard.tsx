...
export function SummaryStatCard({
  ...
  return (
    <Card className="border-border/50 bg-card hover:border-primary/20 group relative h-full overflow-hidden py-3 shadow-lg/5 backdrop-blur-sm transition-all">
