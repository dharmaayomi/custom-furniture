  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (
        ...
        formData.materialCategory.length === 0 ||
        !formData.price ||
        imageItems.length === 0
      ) {
        setSubmitMessage(
          "Please fill in all required fields and upload image.",
        );
        return;
      }
    ...
    <div className="grid gap-6 md:grid-cols-3 md:gap-8">
                  ...
                  <div>
                    ...
                    <Combobox
                      ...
                      onValueChange={(value) =>
                        setFormData((prev) => ({
                          ...prev,
                          materialCategory: Array.isArray(value) ? value : [],
                        }))
                      }
                    >
      ...
      <div className="md:col-span-1">
        <MaterialFormPreview
          ...
          isCategoryTouched={formData.materialCategory.length > 0}
        />
      </div>
    </div>
  );
