      ...
      <SidebarMenuItem>
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <SidebarMenuButton
              size="lg"
              className="gap-2 px-2 py-1 hover:text-primary data-[state=open]:bg-sidebar-accent data-[state=open]:text-primary data-[state=open]:hover:text-primary sm:gap-3 sm:px-3 sm:py-2"
            >
