...
export type TrialAssetCategory = "frame" | "component" | "material";
...
export type MaterialCategory = "FRAME" | "COMPONENT" | "FINISH";
 ...
 * In the current trial flow, this is the same thing as Component Lemari.
 */
export const TRIAL_PRODUCT_COMPONENTS: TrialProductComponent[] = [
  {
    ...
    componentDesc: "Modul laci component untuk frame lemari.",
    componentSku: "COMP-DRW-001",
    price: 1450000,
    weight: 12,
    componentImageUrls: ["/assets/trial/component.webp"],
    isActive: true,
    deletedAt: null,
    createdAt: new Date("2026-01-01T00:00:00.000Z"),
    updatedAt: new Date("2026-01-01T00:00:00.000Z"),
  },
  {
    ...
    componentDesc: "Rak kaca component untuk test attachment.",
  ...
  },
  {
    ...
    componentDesc: "Tiang gantung untuk test component lemari.",
  ...
  },
  {
    ...
    componentDesc: "Partisi vertical component untuk test stacking.",
...
export const TRIAL_PRODUCT_MATERIALS: TrialProductMaterial[] = [
  ...
  },
  {
    ...
    materialUrl: "/assets/trial/component.webp",
    materialDesc: "Finishing walnut untuk component lemari.",
    materialSku: "MAT-WAL-001",
    materialCategories: ["COMPONENT", "FINISH"],
    price: 520000,
    isActive: true,
    createdAt: new Date("2026-01-01T00:00:00.000Z"),
    updatedAt: new Date("2026-01-01T00:00:00.000Z"),
...
const COMPONENT_INITIAL_ROTATION_BY_ID: Partial<
  Record<TrialProductComponent["id"], number>
> = {};

const COMPONENT_FIT_BY_ID: Partial<
  Record<
...
const productComponentToAsset = (
  ...
  size: item.componentCategory ?? "Component",
  price: Math.round(item.price),
  image: item.componentImageUrls[0] ?? "/assets/trial/component.webp",
  modelPath: item.componentUrl,
  category: "component",
  initialRotationY: COMPONENT_INITIAL_ROTATION_BY_ID[item.id],
  fitWidthMode: COMPONENT_FIT_BY_ID[item.id]?.fitWidthMode ?? "keep",
  fitHeightMode: COMPONENT_FIT_BY_ID[item.id]?.fitHeightMode ?? "keep",
  fitDepthMode: COMPONENT_FIT_BY_ID[item.id]?.fitDepthMode ?? "keep",
