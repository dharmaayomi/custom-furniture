...
export const RoomCanvasThreeDB = ({
  productBaseModels,
  activeTexture,
  ...
  }, [productBaseModels, resolveModelUrl]);
  ...
  useEffect(() => {
    ...
    syncModels();
  }, [productComponentModels, resolveModelUrl]); // Trigger saat jumlah berubah
